...
* [Sayna](https://docs.sayna.ai/) [:octocat:](https://github.com/SaynaAI/sayna) - Real-time voice infrastructure for AI agents with unified STT/TTS APIs and WebSocket/REST interfaces.
